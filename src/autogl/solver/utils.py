...
if BACKEND == 'dgl':
    from src.autogl.datasets.utils.conversion import to_dgl_dataset as _convert_dataset
else:
    from src.autogl.datasets.utils.conversion import to_pyg_dataset as _convert_dataset
