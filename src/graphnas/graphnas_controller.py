...
import src.graphnas.utils.tensor_utils as utils
...
class SimpleNASController(torch.nn.Module):
    ...
    def __init__(self, args, search_space, action_list, controller_hid=100, device=True, mode="train",
        ...
        # set hyperparameters
        if args and args.controller.softmax_temperature:
            self.softmax_temperature =args.controller.softmax_temperature
        else:
            self.softmax_temperature = softmax_temperature
        if args and args.controller.tanh_c:
            self.tanh_c = args.controller.tanh_c
        else:
            self.tanh_c = tanh_c
