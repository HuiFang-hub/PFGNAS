...
def load_heteroNLP_data(config, client_cfgs):
    ...
    from src.federatedscope.nlp.hetero_tasks.dataset.get_data import \
        HeteroNLPDataLoader, SynthDataProcessor
    from src.federatedscope.nlp.hetero_tasks.dataloader.datacollator import \
        DataCollator
    ...
    class HeteroNLPDataset(object):
        ...
        def _process_data(self, data, data_name, split, tokenizer, model_type,
            ...
            if data_name == 'imdb':
                from src.federatedscope.nlp.hetero_tasks.dataset.imdb import \
                    process_imdb_dataset
                process_func = process_imdb_dataset
            elif data_name == 'agnews':
                from src.federatedscope.nlp.hetero_tasks.dataset.agnews import \
                    process_agnews_dataset
                process_func = process_agnews_dataset
            elif data_name == 'squad':
                from src.federatedscope.nlp.hetero_tasks.dataset.squad import \
                    process_squad_dataset
                process_func = process_squad_dataset
            elif data_name == 'newsqa':
                from src.federatedscope.nlp.hetero_tasks.dataset.newsqa import \
                    process_newsqa_dataset
                process_func = process_newsqa_dataset
            elif data_name == 'cnndm':
                from src.federatedscope.nlp.hetero_tasks.dataset.cnndm import \
                    process_cnndm_dataset
                process_func = process_cnndm_dataset
            elif data_name == 'msqg':
                from src.federatedscope.nlp.hetero_tasks.dataset.msqg import \
