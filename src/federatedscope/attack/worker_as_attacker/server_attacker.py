from src.federatedscope.core.workers import Server
...
import copy
from src.federatedscope.attack.auxiliary.utils import get_data_sav_fn, \
    get_reconstructor
...
import torch
import numpy as np
from src.federatedscope.attack.privacy_attacks.passive_PIA import \
...
class PassiveServer(Server):
    ...
    def __init__(self,
        ...
        from src.federatedscope.attack.auxiliary.utils import get_data_info
