...
def extend_fl_setting_cfg(cfg):
    ...
    # FedPUB
    cfg.federate.n_workers = 1   #client_num+1
    cfg.federate.n_eps = 1
    cfg.federate.frac = 1.0
    cfg.federate.laye_mask_one = True
    cfg.federate.clsf_mask_one = True
    cfg.federate.agg_norm = 'exp'
    cfg.federate.norm_scale = 10
    cfg.federate.n_proxy = 5
    cfg.federate.l1 = 1e-3
    cfg.federate.loc_l2 = 1e-3

    cfg.federate.base_lr = 1e-3
    cfg.federate.min_lr = 1e-3
    cfg.federate.momentum_opt = 0.9
    cfg.federate.weight_decay = 1e-6
    cfg.federate.warmup_epochs = 10
    cfg.federate.base_momentum = 0.99
    cfg.federate.final_momentum = 1.0
