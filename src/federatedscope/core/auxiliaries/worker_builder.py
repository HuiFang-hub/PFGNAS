...
def get_client_cls(cfg):
    ...
    elif client_type == 'darts':
        from src.federatedscope.gfl.fedDarts.worker import DartsClient
        client_class = DartsClient
    else:
        client_class = Client
...
def get_server_cls(cfg):
    ...
    elif server_type == 'darts':
        from src.federatedscope.gfl.fedDarts.worker import DartsServer
        server_class = DartsServer
    else:
        server_class = Server
