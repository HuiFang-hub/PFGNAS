...
from src.federatedscope.nlp.hetero_tasks.metric import *

logger = logging.getLogger(__name__)

try:
    from src.federatedscope.contrib.metrics import *
except ImportError as error:
    logger.warning(
        f'{error} in `src.federatedscope.contrib.metrics`, some modules are not '
        f'available.')
