...
from src.federatedscope.core.data.utils import merge_data
...
class StandaloneDataDict(dict):
    ...
    def attack(self, datadict):
        ...
        if 'backdoor' in self.global_cfg.attack.attack_method and 'edge' in \
            ...
            import os
            import torch
            from src.federatedscope.attack.auxiliary import \
        ...
        if 'backdoor' in self.global_cfg.attack.attack_method:
            from src.federatedscope.attack.auxiliary import poisoning
