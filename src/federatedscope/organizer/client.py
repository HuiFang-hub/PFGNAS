...
from src.federatedscope.organizer.cfg_client import server_ip
from src.federatedscope.organizer.utils import SSHManager, config2cmdargs, \
    flatten_dict
...
class OrganizerClient(cmd2.Cmd):
    ...
    def __init__(self):
        ...
        self.intro = style(
            ...
            bg=Bg.WHITE,
            bold=True)
        self.prompt = 'src.federatedscope>> '
