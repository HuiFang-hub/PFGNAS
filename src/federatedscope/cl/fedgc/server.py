...
from src.federatedscope.core.auxiliaries.utils import merge_dict
from src.federatedscope.cl.fedgc.utils import global_NT_xentloss
    ...
    def callback_funcs_global_loss(self, message: Message):
        ...
        Arguments:
            message: The received message, which includes sender, receiver,
                ...
                src.federatedscope.core.message
        """
        if self.is_finish:
            return 'finish'
